...
function selectItem(e) {
    removeBorder();/*call the function first as it removes border before all 3 gets selected upon clicking each of the tabs. Then, go create the removeBorder function*/
    removeShow();
